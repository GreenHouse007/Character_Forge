...
export const summoner: CharacterClass = {
  ...
  source: 'APG',
  description:
    'While many who dabble in the arcane become combatants or spellcasters, a summoner forges a powerful bond with one particular outsider, known as an eidolon, who gains power as the summoner becomes more proficient at his summoning. Over time, the two become linked, eventually leading to the summoner becoming a conduit for the power of his eidolon.',
  hitDie: 8,
  ...
  classResources: [
    {
      name: 'Summon Monster',
      description:
        'Starting at 1st level, a summoner can cast summon monster I as a spell-like ability a number of times per day equal to 3 + his Charisma modifier. At 3rd level and every 2 levels thereafter, the power of this ability increases by one spell level, allowing him to summon more powerful creatures.',
  ...
  classFeatures: [
    ...
    },
    {
      ...
      level: 1,
      description:
        'Starting at 1st level, a summoner forms a close bond with his eidolon. Whenever the eidolon takes enough damage to send it back to its home plane, the summoner can, as a free action, sacrifice any number of hit points. Each hit point sacrificed in this way prevents 1 point of damage done to the eidolon.',
    },
    {
      name: 'Summon Monster',
      level: 1,
    ...
    },
    {
      ...
      level: 6,
      description:
        'At 6th level, as a standard action, a summoner can call his eidolon to his side. This functions as dimension door, using the summoner\'s caster level. When used, the eidolon appears adjacent to the summoner (or as close as possible if all adjacent spaces are occupied). The summoner can use this ability once per day at 6th level, plus one additional time per day for every four levels beyond 6th.',
    },
    {
      name: 'Transposition',
      level: 8,
    ...
    },
    {
      ...
      level: 12,
      description:
        'At 12th level, whenever an ally is within the eidolon\'s reach, the ally receives a +2 shield bonus to its Armor Class and a +2 circumstance bonus on its saving throws. If the summoner is within his eidolon\'s reach, these bonuses increase to +4.',
    },
    {
      name: 'Life Bond',
      level: 14,
    ...
    },
    {
      ...
      level: 16,
      description:
        'At 16th level, as a full-round action, a summoner can touch his eidolon and the two merge together. The summoner emerges from the body of the eidolon, which then takes on a form that appears to be the summoner. The summoner can use this ability for a number of rounds per day equal to his summoner level. The summoner can end this effect at any time as a swift action.',
    },
    {
      name: 'Greater Aspect',
      level: 18,
